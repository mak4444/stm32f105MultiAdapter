...
// mmo struct can_frame_s *can_receive(void);
...
volatile int  CanCnt(void);  /*  get how many bytes are in the buffer*/

struct can_frame_s * CanGet(void); /*  get a character from the buffer*/
