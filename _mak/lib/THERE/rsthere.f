...
\ CR ." PWAIT=" DUP >NAME ID.
    >R \ F7_ED
    BEGIN
	T-C@ \	BEGIN	T-C@ DUP BL U< 0= OVER 0xFF <> AND
\	WHILE	EMIT FJB
\	REPEAT
     DUP 0xFF = IF DROP T-C@ \ CR ." Cmd=" DUP H.
		THEN
\ CR ." PW=" DUP H.  FJB
